            ...
            <Container className="sideBar">
                <Grid.Column width={4}>
                    <Menu fluid vertical tabular="right">
                        <Menu.Item
                            name="search"
                            active={this.props.mainAreaContent === 'search'}
                        ...
                        <Menu.Item
                            name="visual-deck"
                            active={
                                this.props.mainAreaContent === 'visual-deck'
                            }
                            onClick={this.handleMenuChange}
                        />
                    </Menu>
                ...
                <br />
                <DeckToolbar
                    sortDeck={this.props.sortDeck}
                    downloadDeck={this.props.downloadDeck}
                />
                <br />
                <Statistic.Group widths="3">
                    <Statistic>
                        <Statistic.Value>
                            {DeckUtils.getCardCount(this.props.deck)}
                        </Statistic.Value>
                        <Statistic.Label>Cards</Statistic.Label>
                    </Statistic>
                    <Statistic>
                        <Statistic.Value>
                            {DeckUtils.getTypeCount(
                                this.props.deck,
                                CardType.Land
                            )}
                        </Statistic.Value>
